package net.mcreator.levelupreborn;
...
@Mod("levelupreborn")
public class LeveluprebornMod {
	public static final Logger LOGGER = LogManager.getLogger(LeveluprebornMod.class);
	public static final String MODID = "levelupreborn";

	public LeveluprebornMod(IEventBus modEventBus) {
